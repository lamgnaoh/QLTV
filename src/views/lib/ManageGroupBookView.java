...
public class ManageGroupBookView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Thêm bộ sách ");

        jLabel1.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(204, 0, 0));
        jLabel1.setText("Thêm bộ sách");
        jLabel1.setToolTipText("");

        jLabel2.setText("Tên bộ sách");
    ...
    private void btnAdd(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdd
        if (groupBookController.addGrb(jTextField1.getText())) {
    ...
    public static void main() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManageGroupBookView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
