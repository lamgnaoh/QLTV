...
// them category
// thuc hien boi thủ thư 
public class ManageCategoryView extends javax.swing.JFrame {
    ...
    // button thêm category
    private void btnAdd(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdd
        if (categoryController.addCategory(jTextField1.getText())) {
            JOptionPane.showMessageDialog(null, "Them thể loại thanh cong");
        } else {
            JOptionPane.showMessageDialog(null, "Them thể loại that bai");
        }
    ...
    public static void main() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManageCategoryView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
